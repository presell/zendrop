...
import sty from "./PlasmicBodyArticle1.module.css"; // plasmic-import: qp4CepOrTNn1/css
...
function PlasmicBodyArticle1__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__qEDbr)}
        component={Link}
        href={(() => {
          try {
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__uIhZ)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__sDs0W)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__vnbmS)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__lovqd)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___9C9H8)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___9Hf4)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column___3BpJi)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            <div className={classNames(projectcss.all, sty.column__lNnlN)}>
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__qCiqs)}
                displayHeight={
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? ("70%" as const)
                    : ("80%" as const)
            ...
            <div className={classNames(projectcss.all, sty.column___8YeTb)}>
              <div
              ...
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__kkiFx)}
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___8Uz4V)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
