...
import sty from "./PlasmicCwAdvert3.module.css"; // plasmic-import: l_wJKAfEnxEq/css
...
function PlasmicCwAdvert3__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.columns___0Rlgy)}>
          <div className={classNames(projectcss.all, sty.column__sfItw)}>
            <p.PlasmicLink
              className={classNames(
                projectcss.all,
                projectcss.a,
          ...
          <div className={classNames(projectcss.all, sty.column__lHN8)}>
            <div
      ...
      >
                  ...
                  return __wrapUserFunction(
                    {
                      ...
                      interactionUuid: "kE68B_j7YOBA",
                      componentUuid: "l_wJKAfEnxEq"
                    },
                    () =>
        ...
        <div className={classNames(projectcss.all, sty.freeBox___0Uofx)}>
          <p.PlasmicImg
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__wf6R0)}>
          <div
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox__wc0X0)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ifEFt)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            >
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__p3QVc)}
                displayHeight={"auto" as const}
                displayMaxHeight={"none" as const}
                displayMaxWidth={"100%" as const}
                displayMinHeight={"0" as const}
            ...
            >
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__mkWw2)}
                displayHeight={"auto" as const}
                displayMaxHeight={"none" as const}
                displayMaxWidth={"100%" as const}
                displayMinHeight={"0" as const}
            ...
            >
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__tLKnF)}
                displayHeight={"auto" as const}
                displayMaxHeight={"none" as const}
                displayMaxWidth={"100%" as const}
                displayMinHeight={"0" as const}
            ...
            >
              ...
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__jKjHf)}
                  displayHeight={
                    hasVariant(globalVariants, "screen", "mobileOnly")
                      ? ("auto" as const)
                      : ("422px" as const)
            ...
            <div className={classNames(projectcss.all, sty.freeBox__mePyH)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__vlskr)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__e166Z)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__pSrex)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__h44Gp)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__t4J62)}>
              <p.PlasmicLink
              ...
              <div className={classNames(projectcss.all, sty.freeBox__vUuZf)} />

              <div className={classNames(projectcss.all, sty.freeBox__nzrVv)}>
                <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox__nn4)}>
            <div className={classNames(projectcss.all, sty.freeBox___3HKnS)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__sFkB2)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__auSp9)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zAwo5)}>
              <p.PlasmicImg
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.columns__cgE0X)}
          >
            {(
              hasVariant(globalVariants, "screen", "mobileOnly") ? true : true
            ) ? (
