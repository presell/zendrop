...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: k_-PSalGVtgR/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__fQeVw)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__nun0K)}
                role={"img"}
              />
            ),
